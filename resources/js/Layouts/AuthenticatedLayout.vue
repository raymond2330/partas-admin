...
<template>
    <div>
        <div class="min-h-screen bg-[#bcc8ed]">
            <Navbar />
            ...
            <main class="bg-[#bcc8ed] shadow ">
                <div class="grid grid-cols-6 grid grid-rows-1 min-h-screen ">
                    <div class="mt-[42px] ml-5 flex flex-col fixed">
                        ...
                        <button class="mt-7" @click="toggleSidebar">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 18 18"
                                stroke="currentColor"
                                class="flex-shrink-0 w-5 h-5 text-white transition duration-75 dark:text-gray-400 group-hover:text-white hover:text-[#929abc] "
                                aria-hidden="true">
                                <path
                    ...
                    <div class="p-4 col-start-2 col-end-6 mt-16 ">
